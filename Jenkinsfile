        ...
        stage('Prepare Environment') {
          ...
          stage("Build (Compile App)") {
            ...
            steps {
                ...
                echo '### Running tests ###'
                sh 'python manage.py test   --with-coverage --cover-erase --cover-package=skill_app --with-xunit --xunit-file=xunittest.xml --cover-branches --cover-html --settings=lxp_skill_service.settings.dev'
